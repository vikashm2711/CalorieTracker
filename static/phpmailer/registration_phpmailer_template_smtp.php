...
try {
    ...
    $mail->Host       = 'd8sy-wwvb.accessdomain.com';           // Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = 'demos@ansonika.com';                 // SMTP username
    $mail->Password   = 'Martignano75!';                        // SMTP password
